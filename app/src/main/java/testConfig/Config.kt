...
class Config {
    companion object {
        const val ORG_NAME: String = "Viasat Connect"
        const val SERVER: String = "dev.veranda.viasat.io"
        ...
        const val UPDATED_AVATAR: String = "$CURRENT_SERVER/avatar/$USERNAME?format=jpeg"
